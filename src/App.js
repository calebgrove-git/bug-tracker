...
<BrowserRouter>
  ...
  <Route path='/bugs/completed' exact><ViewCompleted/></Route>
  ...
  <Route path='/bugs/:priority' exact><ViewBugs/></Route>
  <Route path='/createUser' exact><div className='page-container' ><CreateUser/></div></Route>
